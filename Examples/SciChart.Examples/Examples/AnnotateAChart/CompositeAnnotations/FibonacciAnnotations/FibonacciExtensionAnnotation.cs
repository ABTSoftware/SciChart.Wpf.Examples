...
//
// FibonacciExtensionAnnotation.cs is part of the SCICHART® Examples. Permission is hereby granted
...
{
    public class FibonacciExtensionAnnotation : FibonacciCompositeAnnotation
    {
