...
//
// PlaneProjector.cs is part of the SCICHART® Examples. Permission is hereby granted
...
namespace SciChart.Examples.ExternalDependencies.Controls.CoverFlow
{
    ...
    public class PlaneProjector : FrameworkElement
    {
        #region Public API
        ...
        public static readonly DependencyProperty RotationXProperty =
            DependencyProperty.Register("RotationX", typeof(double), typeof(PlaneProjector), new PropertyMetadata(0.0, (d, args) => ((PlaneProjector)d).UpdateRotation()));
        public static readonly DependencyProperty RotationYProperty =
            DependencyProperty.Register("RotationY", typeof(double), typeof(PlaneProjector), new PropertyMetadata(0.0, (d, args) => ((PlaneProjector)d).UpdateRotation()));
        public static readonly DependencyProperty RotationZProperty =
            DependencyProperty.Register("RotationZ", typeof(double), typeof(PlaneProjector), new PropertyMetadata(0.0, (d, args) => ((PlaneProjector)d).UpdateRotation()));
        public static readonly DependencyProperty FieldOfViewProperty =
            DependencyProperty.Register("FieldOfView", typeof(double), typeof(PlaneProjector), new PropertyMetadata(45.0, (d, args) => ((PlaneProjector)d).Update3D(),
        ...
        private class LayoutInvalidationCatcher : Decorator
        {
            ...
            {
                PlaneProjector pl = this.Parent as PlaneProjector;
                if (pl != null)
                {
