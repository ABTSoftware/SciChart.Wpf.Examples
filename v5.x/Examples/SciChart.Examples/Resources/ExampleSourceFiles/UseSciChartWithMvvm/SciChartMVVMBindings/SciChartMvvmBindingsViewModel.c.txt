...
namespace SciChart.Examples.Examples.UseSciChartWithMvvm.SciChartMVVMBindings
{
    public class SciChartMvvmBindingsViewModel : BaseViewModel
    {
        ...
        private void InitializeAnnotations()
        {
            ...
            AnnotationViewModels.Add(
                new HorizontalLineAnnotationViewModel
                {
            ...
            AnnotationViewModels.Add(
                new LineArrowAnnotationViewModel
                {
                    Stroke = Colors.Cyan,
                    StrokeThickness = 2,
                    X1 = 1.2,
            ...
            AnnotationViewModels.Add(
                new AxisMarkerAnnotationViewModel
                {
                    X1 = 4,
                    Y1 = 3,
