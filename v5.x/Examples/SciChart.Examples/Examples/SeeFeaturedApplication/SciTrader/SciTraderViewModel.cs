...
namespace SciChart.Examples.Examples.SeeFeaturedApplication.SciTrader
{
    public class SciTraderViewModel : BaseViewModel
    {
        ...
        private void UpdatePriceChart(PriceSeries priceData)
        {
            ...
            PriceData = (IOhlcDataSeries<DateTime, double>) (UseDiscontinuousDateTimeAxis ? new DiscontinuousFilter<double>(_ohlcDataSeries, Calendar).FilteredDataSeries : _ohlcDataSeries);
            ...
            Sma200Series = UseDiscontinuousDateTimeAxis ? (IXyDataSeries<DateTime, double>)new MovingAverageFilter<DateTime, double>(xyDataSeries, 200, Calendar).FilteredDataSeries :
                                                          (IXyDataSeries<DateTime, double>)new MovingAverageFilter<DateTime, double>(xyDataSeries, 200).FilteredDataSeries;
            Sma200Series.SeriesName = "200 SMA";

            // Create a series for the 50 period SMA which will be plotted as a line chart
            Sma50Series = UseDiscontinuousDateTimeAxis ? (IXyDataSeries<DateTime, double>)new MovingAverageFilter<DateTime, double>(xyDataSeries, 50, Calendar).FilteredDataSeries :
                                                         (IXyDataSeries<DateTime, double>)new MovingAverageFilter<DateTime, double>(xyDataSeries, 50).FilteredDataSeries;
