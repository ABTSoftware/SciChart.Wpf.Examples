...
namespace SciChart.Sandbox.Examples.DoubleAxisAsDateTimeAxis
{
    /// <summary>
    /// Interaction logic for DoubleAxisAsDateTimeAxis.xaml
    /// </summary>
    [TestCase("LabelProvider: DoubleAxis as DateTimeAxis")]
